...
func (_m *IKeycloakRepository) CreateUser(ctx context.Context, token string, role *gocloak.Role, user gocloak.User) (string, error) {
...
func (_m *IKeycloakRepository) DeleteUserByID(ctx context.Context, token string, userID string) error {
...
func (_m *IKeycloakRepository) GetAllUsers(ctx context.Context, token string) ([]*gocloak.User, error) {
...
func (_m *IKeycloakRepository) GetRoleByID(ctx context.Context, token string, roleID string) (*gocloak.Role, error) {
...
func (_m *IKeycloakRepository) GetUserByID(ctx context.Context, token string, userID string) (*gocloak.User, error) {
	ret := _m.Called(ctx, token, userID)
...
func (_m *IKeycloakRepository) GetUserByNickName(ctx context.Context, token string, nickName string) (*gocloak.User, error) {
...
func (_m *IKeycloakRepository) IsValidToken(ctx context.Context, accessToken string) (bool, error) {
...
func (_m *IKeycloakRepository) Login(ctx context.Context, user string, password string) (*gocloak.JWT, error) {
...
func (_m *IKeycloakRepository) Logout(ctx context.Context, refreshToken string) error {
